...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230510_bankbee_4e840008b6c025962427_20230510070238_archive.zip';
        const ARCHIVE_SIZE       = '259963993';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '4e84000-10070238';
        const SECONDARY_PACKAGE_HASH = '6ac4fec-10070238';
        const VERSION            = '1.5.4';
